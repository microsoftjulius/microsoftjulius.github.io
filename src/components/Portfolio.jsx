    ...
    return (
        ...
        <div className="container text-center">
            ...
            <a href="https://bac.ac.ug/" target="_blank" className="portfolio-card">
                <img src="https://i.ibb.co/zn4486v/bac.png" className="portfolio-card-img" alt="image" />
                ...
                <div className="col-md-4">
                    <a href="https://ugsms.com/" target="_blank" className="portfolio-card">
                        <img className="portfolio-card-img img-responsive rounded"
                        src="https://i.ibb.co/0s1jBgn/ugsms.png"
                        alt="image" />
                        <span className="portfolio-card-overlay">
                            <span className="portfolio-card-caption">
                                <h4>Ugsms</h4>
                ...
                <div className="col-md-4">
                    <a href="http://20.84.92.118/" target="_blank" className="portfolio-card">
                        <img className="portfolio-card-img img-responsive rounded"
                        src="https://i.ibb.co/Cb2LTjj/my-ug-online.png"
                        alt="image" />
                        <span className="portfolio-card-overlay">
                            <span className="portfolio-card-caption">
